class UsersController < ApplicationController
    ...
    def service
        response = open('https://auth.ut.ac.ir:8443/cas/serviceValidate?service=https%3A%2F%2Fsn.ut.ac.ir%2Fusers%2Fservice&ticket='+params[:ticket], {ssl_verify_mode: OpenSSL::SSL::VERIFY_NONE}).read
        ...
        if !result['serviceResponse']['authenticationSuccess'].blank?
            ...
            redirect_to("https://sn.ut.ac.ir/#!/login_error/")
